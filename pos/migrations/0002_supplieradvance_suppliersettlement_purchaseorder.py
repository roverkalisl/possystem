    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("order_type", models.CharField(choices=[("item", "Item"), ("service", "Service"), ("rental", "Rental"), ("other", "Other")], default="service", max_length=20)),
                ("description", models.CharField(max_length=255)),
                ...
                ("status", models.CharField(choices=[("draft", "Draft"), ("approved", "Approved"), ("partially_used", "Partially Used"), ("closed", "Closed")], default="draft", max_length=20)),
                ("note", models.TextField(blank=True, null=True)),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ...
                ("project", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="purchase_orders", to="pos.project")),
